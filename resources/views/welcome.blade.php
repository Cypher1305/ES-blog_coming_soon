...
<body class="items-center justify-center h-full text-gray-800 text-center w-full">
    ...
    <div class="relative z-10 mt-[55px] bg-white space-y-8 w-[30%] justify-center items-center mx-auto ">
        <img src="log.png" alt="ES-Blog Logo" class="mx-auto w-52 h-auto">
        ...
        <h1 class="text-xl font-bold">Technologies - Inspirations - Connections</h1>
        <div id="socials" class="flex justify-center space-x-8">
            <a href="#" target="_blank" class="text-[#00bfff] text-5xl transition-transform transform hover:scale-110"><i class="fab fa-linkedin"></i></a>
            <a href="http://www.youtube.com/@esblogci" target="_blank" class="text-[#00bfff] text-5xl transition-transform transform hover:scale-110"><i class="fab fa-youtube"></i></a>
            <a href="#" target="_blank" class="text-[#00bfff] text-5xl transition-transform transform hover:scale-110"><i class="fab fa-tiktok"></i></a>
            <a href="https://whatsapp.com/channel/0029VaWUvU84tRrqQPPujC2I" target="_blank" class="text-[#00bfff] text-5xl transition-transform transform hover:scale-110"><i class="fab fa-whatsapp"></i></a>
            <a href="https://www.facebook.com/profile.php?id=61558122104581" target="_blank" class="text-[#00bfff] text-5xl transition-transform transform hover:scale-110"><i class="fab fa-facebook"></i></a>
            <a href="#" target="_blank" class="text-[#00bfff] text-5xl transition-transform transform hover:scale-110"><i class="fab fa-instagram"></i></a>
        </div>
    ...
    <script>
        function updateCountdown() {
            ...
            const timer = setInterval(() => {
                ...
                // Mettre à jour chaque élément du DOM
